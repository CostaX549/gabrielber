...
<template>
  <div class="pt-16">
     <h1 class="text-3xl font-semibold mb-4">Digite seu número de telefone</h1>
     <form v-if="!waitingOnVerification" @submit.prevent="handleLogin">
        <div class="overflow-hidden shadow sm:rounded-md max-w-sm mx-auto text-left">
            <div class="bg-white px-4 py-5 sm:p-6">
                <div>
                    <input type="text" v-maska data-maska="+## (##) #####-####" v-model="credentials.phone" name="phone" id="phone" placeholder="+55 (11) 91234-5678"
